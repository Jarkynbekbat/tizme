...
class LocalNotificationsService {
  static Future<bool> addNotification({Map<String, dynamic> notification}) async {
    ...
    List<String> notificationsList =
        sharedPreferences.getStringList('notifications') != null ? sharedPreferences.getStringList('notifications') : [];
  ...
  static Future<List<String>> getNotificattions() async {
    SharedPreferences sharedPreferences = await SharedPreferences.getInstance();
    return sharedPreferences.getStringList('notifications') != null ? sharedPreferences.getStringList('notifications') : [];
  }

  static Future<bool> deleteNotification(String date) async {
    SharedPreferences sharedPreferences = await SharedPreferences.getInstance();
    List<String> notificationsList = sharedPreferences.getStringList('notifications');
